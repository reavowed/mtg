...
object InstructionResult {
  case class NewInstructions(instructions: Seq[ResolvableInstructionPart], resolutionContext: StackObjectResolutionContext) extends InstructionResult
  ...
  implicit def instructionToInstructionResult(tuple: (ResolvableInstructionPart, StackObjectResolutionContext)): InstructionResult = NewInstructions(Seq(tuple._1), tuple._2)
  implicit def instructionsToInstructionResult(tuple: (Seq[ResolvableInstructionPart], StackObjectResolutionContext)): InstructionResult = NewInstructions(tuple._1, tuple._2)
