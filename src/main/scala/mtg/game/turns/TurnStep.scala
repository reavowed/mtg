...
object TurnStep {
  ...
  case object UpkeepStep extends TurnStep(Seq(AllPlayersGetPriorityAction))
  case object DrawStep extends TurnStep(Seq(DrawForTurn, AllPlayersGetPriorityAction))
