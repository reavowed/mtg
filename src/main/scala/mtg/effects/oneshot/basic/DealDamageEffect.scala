...
case class DealDamageEffect(sourceIdentifier: SingleIdentifier[ObjectId], recipientIdentifier: SingleIdentifier[ObjectOrPlayer], amount: Int) extends OneShotEffect {
